(function() {
    ...
    function startTimer() {
        ...
        // Capture exact start time first to ensure accurate timestamp
        startTime = Date.now();
        timerIsRunning = true;
        
        // Create timestamp using the exact same startTime to ensure perfect alignment
        const startDate = new Date(startTime);
        const formattedTimestamp = startDate.getFullYear() + '-' + 
        ...
        currentSession = {
            timestamp: formattedTimestamp,  // Uses the exact same time as startTime
