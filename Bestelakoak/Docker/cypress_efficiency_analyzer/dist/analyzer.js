 ...
 */
function countCommandsWithRegex(content, testName, actionableCommands) {
    const commands = [];
    let count = 0;
 ...
 */
function analyzeFile(filePath, actionableCommands, excludedCommands) {
    var _a, _b;
    let content;
        ...
        (0, traverse_1.default)(ast, {
            CallExpression: {
                enter(path) {
                    ...
                    else if (context.currentTestName &&
        ...
        try {
            ...
            return {
                ...
                errorDetails: {
                    ...
                    line: (_a = astError.loc) === null || _a === void 0 ? void 0 : _a.line,
                    column: (_b = astError.loc) === null || _b === void 0 ? void 0 : _b.column,
                    filename: filename
                }
            };
        }
...
function analyzeFiles(filePaths, actionableCommands, excludedCommands) {
    const testFiles = {};
    let successCount = 0;
    let errorCount = 0;
...
function calculateSummary(testFiles) {
