...
exports.CopilotPerformanceTracker = void 0;
const vscode = require("vscode");
const fs = require("fs");
const path = require("path");
class CopilotPerformanceTracker {
    constructor() {
        var _a;
        this.disposables = [];
        ...
        const extensionPath = (_a = vscode.extensions.getExtension('copilot-performance-tracker')) === null || _a === void 0 ? void 0 : _a.extensionPath;
        if (extensionPath) {
    ...
    startTracking() {
        ...
        const completionListener = vscode.languages.registerCompletionItemProvider({ scheme: 'file' }, {
    ...
    showStatistics() {
        ...
        const statsPanel = vscode.window.createWebviewPanel('copilotStats', 'Copilot Performance Statistics', vscode.ViewColumn.One, {});
...
exports.CopilotPerformanceTracker = CopilotPerformanceTracker;
