...
class SimplifiedCopilotChat {
    ...
    static async sendMessage(message) {
        try {
            ...
            vscode.window.showInformationMessage('Message copied to clipboard. Please paste it into the Copilot Chat input box if it was not sent automatically.', 'OK');
        }
        catch (error) {
     ...
     */
    static async runPromptSequence(prompts) {
...
exports.SimplifiedCopilotChat = SimplifiedCopilotChat;
//# sourceMappingURL=simplifed-chat.js.map