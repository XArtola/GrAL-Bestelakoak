 ...
 * navigates to the prompts subfolder, and extracts content from all .spec.txt files.
 */
...
/**
 * Combined Explorer and Chat Automation
 * Integrates file exploration with chat context and submission
 */
function explorerAndChatAutomation() {
    // Chat automation functions
    async function addContextAndSendToChat(text = "") {
        ...
        try {
            ...
            // Check if preparePrompts context is already added
    ...
    async function runFullAutomation() {
        ...
        try {
            ...
            await addContextAndSendToChat(formattedContent);
    ...
    return {
        ...
        sendToChat: (text) => {
            ...
            return addContextAndSendToChat(text);
        },
        ...
        exploreAndSend: async () => {
            ...
            return addContextAndSendToChat(formattedContent);
        }
    };
}
