              ...
              {hasTestData && testData.testData.map((llm, index) => {
                ...
                return (
                  <tr key={index} className={index % 2 === 0 ? 'bg-gray-800' : 'bg-gray-750'}>
                    <td className="px-4 py-3 text-left font-medium">{getLlmDisplayName(normalizeLlmName(llm.llmName))}</td>
            ...
            <thead className="bg-gray-700">
              <tr>
                ...
                {hasTestData && testData.llms.map((llmName, index) => (
                  <th key={index} className="px-2 py-3 text-center text-xs font-medium text-white" colSpan={2}>{getLlmDisplayName(normalizeLlmName(llmName))}</th>
                ))}
              </tr>
              <tr>
                        ...
                        return (
                          <tr key={index} className={`${index % 2 === 0 ? 'bg-gray-800' : 'bg-gray-750'} ${rankColorClass && 'bg-opacity-50'}`}>
                            ...
                            <td className="px-4 py-3 text-left font-medium">
                              {getLlmDisplayName(normalizeLlmName(ranking.llm))}
                            </td>
              ...
              <div className="mb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="bg-gray-800 p-4 rounded-lg">
                    ...
                    <p className="text-lg font-bold text-white">{getLlmDisplayName(normalizeLlmName(efficiencyData.insights.fastestLLM))}</p>
                  ...
                  <div className="bg-gray-800 p-4 rounded-lg">
                    ...
                    <p className="text-lg font-bold text-white">{getLlmDisplayName(normalizeLlmName(efficiencyData.insights.mostAccurateLLM))}</p>
