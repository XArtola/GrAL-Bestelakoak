...
outputDirs.forEach(outputDir => {
  ...
  console.log(`Processing directory ${outputDir} for model ${modelName}...`);  // Look for matched data JSON file
    ...
    if (entry.output_file && entry.code) {
      ...
      try {
        ...
        if (fs.existsSync(sourcePath)) {
          ...
          if (match) {            // Insert the code content after the opening brace of the it block
        ...
        } else {          // If the source file doesn't exist, generate a new file with the content
